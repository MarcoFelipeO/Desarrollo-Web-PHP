...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <h2 class="m-0 text-primary">Cristalerias Toro</h2>
        </a>
...
<p class="uno"> El compromiso de la Alta Dirección, se fundamenta en los siguientes principios: </p>
<hr>
<br>
...
<p class="uno">- Cumplir con todas las normas y requerimientos legales aplicables a la organización y con los otros
     compromisos que esta asuma con las partes interesadas.  <br>
<p class="uno">- Proporcionar los recursos adecuados para el cumplimiento del Sistema de Gestión de Calidad y
     Seguridad, y mantener una comunicación efectiva con todos los involucrados. <br>
<p class="uno">- Proporcionar a nuestro personal un ambiente de trabajo seguro, desarrollar sus conocimientos
     y competencias y el compromiso hacia la calidad y seguridad de nuestros productos.   


<br><br>
<p class="dos">Esta Política del Sistema de Gestión de Calidad y Seguridad será periódicamente revisada para su adecuación
     a los nuevos requerimientos y necesidades de la Empresa y comunicada a toda la Organización y a las partes interesadas.</p>
          </div>
        </div>
      </div>
    </div>
